...
def send_notification_email(requester_email, requester_name, hall_name, action):
    subject = f"Your Booking Request for {hall_name} has been {action}"
    message = f"Dear {requester_name},\n\nYour booking request for {hall_name} has been {action}.\n\nThank you."
